# input dir에 있는 사진들을 output에 binary file로 저장
...
# data directory
input = os.getcwd() + "/data/clustering_data/train"
output = os.getcwd() + "/data/clustering_data/train/test.bin"
imageSize = 32
imageDepth = 3
